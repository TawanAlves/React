<template>
  <div>
    <a-card title="基本信息" style="margin: 15px;">
      ...
      <a-row :gutter="24">
        <a-col :span="24">
          <div style="margin: 10px 0;">作业人:</div>
        </a-col>
        <a-table
          ref="table"
          size="default"
      ...
      <a-row :gutter="24">
        <a-col :span="24">
          <a-form-item label="动土作业范围、内容、方式" :label-col="{span: 3}" :wrapper-col="{span:19}">
            <a-input :value="formData.workContent" disabled/>
          </a-form-item>
        </a-col>
        <a-col :span="24" v-if="false">
          <a-form-item label="作业简图" :label-col="{span: 7}" :wrapper-col="{span:10}">
...
import PersonHistory from '@/views/safety/task/component/PersonHistory'
export default {
  name: 'BasicInfo',
  components: { PersonHistory },
  props: {
    ticketId: {
      type: String,
      default: '',
