<template>
  <div>
    <a-card title="基本信息" style="margin: 15px;">
      <a-form class="ant-advanced-search-form">
        <a-row :gutter="24">
          ...
          <a-col :span="12">
            <a-form-item label="含氧量(VOL)">
              <a-input :value="lastAnalysis.oxygenContent" disabled/>
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="可燃气(LEL)">
              <a-input :value="lastAnalysis.flammableGas" disabled/>
            </a-form-item>
          </a-col>
    ...
    <a-card title="历史分析" style="margin: 15px;">
      <a-table
        ref="table-history"
        size="default"
        :rowKey="(index) => (index)"
