...
export default {
  ...
  props: ['value', 'cmpType', 'showDuration', 'tag', 'tagIcon', 'defaultValue', 'labelWidth', 'rangeSeparator', 'startPlaceholder', 'endPlaceholder', 'clearable', 'format', 'valueFormat', 'regList', 'changeTag', 'proCondition', 'asSummary', 'formId', 'renderKey', 'layout', 'value'],
  name: 'FcDateDuration',
  data () {
    return {
