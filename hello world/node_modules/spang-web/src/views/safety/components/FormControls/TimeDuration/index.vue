...
export default {
  ...
  props: ['value', 'cmpType', 'showDuration', 'tag', 'tagIcon', 'defaultValue', 'labelWidth', 'clearable', 'isRange', 'rangeSeparator', 'startPlaceholder', 'endPlaceholder', 'format', 'valueFormat', 'regList', 'changeTag', 'proCondition', 'asSummary', 'formId', 'renderKey', 'layout', 'value'],
  name: 'FcTimeDuration',
  data () {
    return {
