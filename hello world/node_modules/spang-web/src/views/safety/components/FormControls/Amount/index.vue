...
export default {
  ...
  props: ['value', 'cmpType', 'tag', 'tagIcon', 'precision', 'labelWidth', 'stepStrictly', 'controls', 'controlsPosition', 'regList', 'changeTag', 'proCondition', 'showChinese', 'formId', 'renderKey', 'layout'],
  name: 'FcAmount',
  data () {
    return {
