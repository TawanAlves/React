      ...
      <div class="risk-detail">
        ...
        <section class="risk-detial-header">
          ...
          <div class="info-block" :class="{ active: model.process == 2 }">
            ...
            <div class="info-block-person">{{ evaluationInfomodel.assessorName }}</div>
            <div class="info-block-time">{{ evaluationInfomodel.assessTime }}</div>
          </div>
          <a-icon class="arrow-right" type="arrow-right" />
          <div class="info-block" :class="{ active: model.process == 3 }">
            <div class="info-block-name">整改</div>
            <div class="info-block-person">{{ abarbeitungInfomodel.abarbeitungPerson }}</div>
            <div class="info-block-time">{{ abarbeitungInfomodel.abarbeitungTime }}</div>
          </div>
          <a-icon class="arrow-right" type="arrow-right" />
          <div class="info-block" :class="{ active: model.process == 4 }">
            <div class="info-block-name">验收</div>
            <div class="info-block-person">{{ acceptInfomodel.acceptor }}</div>
            <div class="info-block-time">{{ acceptInfomodel.acceptTime }}</div>
          </div>
        </section>
        <!-- / 头部标识 -->
        ...
        <section class="risk-detail-info report-base">
          ...
          <a-form :label-col="{ span: 6 }" :wrapper-col="{ span: 18 }">
            ...
            <a-row gutter="12" style="margin-bottom: 20px;color: #0c0f1a">
              <a-col :span="7" :offset="1"> 登记时间：{{ basicInfomodel.registerTime }} </a-col>
              <a-col :span="7"> 提报人：{{ basicInfomodel.registrantName }} </a-col>
              <a-col :span="7"> 部门：{{ basicInfomodel.registrantDept }} </a-col>
            </a-row>
            <a-row gutter="20" v-if="basicInfoImgList && basicInfoImgList.length">
              <a-col :span="24">
        ...
        <!-- 评估信息 -->
        <section v-if="evaluationInfomodelShow" class="risk-detail-info report-assess">
          <div class="risk-detail-info-name">2. 评估信息</div>
          <div>
            <fieldset>
              <legend>事故发生的可能性（L）判定准则</legend>

              <a-table size="small" :data-source="[LJudge]" :pagination="false" :rowKey="(record) => record.id" :bordered="true">
            ...
            <fieldset>
              ...
              <a-table size="small" :data-source="[SJudge]" :pagination="false" :rowKey="(record) => record.id" :bordered="true">
                <a-table-column
                  key="seriousScores"
        ...
        <!-- 整改信息 -->
        <section v-if="abarbeitungInfomodelShow" class="risk-detail-info report-reform">
          ...
          <a-form :label-col="{ span: 6 }" :wrapper-col="{ span: 18 }">
            <a-row gutter="0">
              <a-col :span="24">
                <a-form-item :label-col="{ span: 3 }" :wrapper-col="{ span: 21 }" label="整改意见">
                  <a-input
                    v-model="abarbeitungInfomodel.opinion"
                    :disabled="abarbeitungInfomodelDisable"
                  ></a-input> </a-form-item
              ></a-col>
            </a-row>
            ...
            <a-row gutter="20">
              <a-col :span="12">
                <a-form-item label="整改作业人">
                  <a-input
                    v-model="abarbeitungInfomodel.workingPeopleName"
                    :disabled="abarbeitungInfomodelDisable"
                  ></a-input>
                </a-form-item>
              </a-col>
              <a-col :span="12">
                <a-form-item label="整改部门">
                  <a-input v-model="abarbeitungInfomodel.deptName" :disabled="abarbeitungInfomodelDisable"></a-input>
                </a-form-item>
              </a-col>
            </a-row>
            <a-row gutter="20">
              <a-col :span="12">
                <a-form-item label="整改结果">
                  <a-input v-model="abarbeitungInfomodel.resultName" :disabled="abarbeitungInfomodelDisable"></a-input>
                </a-form-item>
              </a-col>
              <a-col :span="12">
                <a-form-item label="验收人">
                  <a-input
                    v-model="abarbeitungInfomodel.acceptorName"
                    :disabled="abarbeitungInfomodelDisable"
                  ></a-input>
                </a-form-item>
              </a-col>
            ...
            <a-row gutter="20">
              <a-col :span="24">
                ...
                >
                  <a-textarea
                    v-model="abarbeitungInfomodel.measure"
                    :disabled="abarbeitungInfomodelDisable"
                  ></a-textarea>
                </a-form-item>
              </a-col>
            ...
            <a-row gutter="20">
              <a-col :span="24">
                <a-form-item label="相关附件" :label-col="{ span: 3 }" :wrapper-col="{ span: 21 }" style="margin-bottom: 0!important;">
                  <upload-file
                    accept=".jpg, .jpeg, .png"
                    :fileList="abarbeitungInfoImgList"
                    :showUploadList="{ showPreviewIcon: true, showRemoveIcon: false }"
                    listType="picture-card"
                    :previewEnabled="true"
                    disabled="true"
        ...
        <!-- 验收信息 -->
        <section v-if="acceptInfomodelShow" class="risk-detail-info report-acceptance">
          <div class="risk-detail-info-name">4. 验收信息</div>
          <a-form :label-col="{ span: 6 }" :wrapper-col="{ span: 18 }">
            <a-row gutter="20">
              <a-col :span="24">
                <a-form-item :label-col="{ span: 3 }" :wrapper-col="{ span: 21 }" label="验收结果">
                  <a-input v-model="acceptInfomodel.resultName" :disabled="acceptInfomodelDisable"></a-input>
                </a-form-item>
              </a-col>
            </a-row>
            ...
            <a-row gutter="20">
              <a-col :span="24">
                <a-form-item :label-col="{ span: 3 }" :wrapper-col="{ span: 21 }" label="验收说明">
                  <a-input v-model="acceptInfomodel.description" :disabled="acceptInfomodelDisable"></a-input>
                </a-form-item>
              </a-col>
            </a-row>
            <a-row gutter="20">
...
export default {
  ...
  data() {
    return {
      ...
      // 整改信息
      abarbeitungInfomodelShow: false,
      abarbeitungInfomodel: {},
      abarbeitungInfoImgList: [],
      abarbeitungInfomodelDisable: true,

      // 验收信息
      acceptInfomodelShow: false,
      acceptInfomodel: {},
      acceptInfoImgList: [],
      acceptInfomodelDisable: true,
    }
  },
  ...
  methods: {
    ...
    setFormData(model) {
      ...
      let { reportInformationVO, assessInformationVO, abarbeitungInformationVO, acceptInformationVO } = data
      // 基础信息
      ...
      if (JSON.stringify(assessInformationVO) == '{}') {
        this.evaluationInfomodelShow = false
      } else {
        this.evaluationInfomodelShow = true
        this.evaluationInfomodelDisable = true
        ...
        Promise.all([this.getLData(this.evaluationInfomodel.ponderanceScore),this.getSData(this.evaluationInfomodel.possibilityScore)]).then((res) => {
          this.setR()
        })
      }

      // 整改信息
      if (JSON.stringify(abarbeitungInformationVO) == '{}') {
        this.abarbeitungInfomodelShow = false
      } else {
        this.abarbeitungInfomodelShow = true
        this.abarbeitungInfomodel = abarbeitungInformationVO
        this.abarbeitungInfoImgList = this.getImgUrlList(abarbeitungInformationVO.files)
        console.log('abarbeitungInformationVO', abarbeitungInformationVO)
      }

      // 验收信息
      if (JSON.stringify(acceptInformationVO) == '{}') {
        this.acceptInfomodelShow = false
      } else {
        this.acceptInfomodelShow = true
        this.acceptInfomodel = acceptInformationVO
        this.acceptInfoImgList = this.getImgUrlList(acceptInformationVO.files)
        console.log('abarbeitungInformationVO', acceptInformationVO)
      }
    },
