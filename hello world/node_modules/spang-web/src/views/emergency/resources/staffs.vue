  ...
  <page-container :title="false">
    <a-card :bordered="false">
          ...
          <a-row :gutter="24">
            ...
            <a-col :md="1">
              <span class="table-page-search-submitButtons">
                <a-button type="primary" @click="$refs.staffsTable.refresh(true)">查询</a-button>
                <a-button type="second" style="margin-left: 10px" @click="staffsRefresh">重置</a-button>
              </span>
            </a-col>
          </a-row>
        </a-form>
      ...
      <div class="table-operator">
        <a-button type="primary" icon="plus" @click="staffsAdd">新增</a-button>
        <a-button icon="delete" :disabled="!hasSelected" @click="staffsRemove">删除</a-button>
      ...
      >
        <span slot="action" slot-scope="text, record">
          <template>
            <a @click="staffsCheck(record)">查看</a>
            <a-divider type="vertical"/>
            <a @click="staffsEdit(record)">编辑</a>
          </template>
        </span>
      </s-table>
    </a-card>
